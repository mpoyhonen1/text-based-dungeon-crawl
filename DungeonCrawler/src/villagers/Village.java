...
public class Village {
    ...
    /**
     * Removes a villager from the village. Villager is given at a specific
     * location.
     * 
     * @param index
     ...
     * 
     * @param villager
     *            the villager to be added to the zoo
     */
     ...
     * 
     * @return the number of villagers in the zoo
     */
    public int size() {
	return this.pointer;
    }
    ...
    public void makeAllVillagesWork() {
    }
